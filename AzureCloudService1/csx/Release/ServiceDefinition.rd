...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="AzureCloudService1" generation="1" functional="0" release="0" Id="95471aa9-3736-4c0f-a0a0-25f43599b4d8" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="AzureCloudService1Group" generation="1" functional="0" release="0">
      <settings>
        <aCS name="Consumidor:APPINSIGHTS_INSTRUMENTATIONKEY" defaultValue="">
          <maps>
            <mapMoniker name="/AzureCloudService1/AzureCloudService1Group/MapConsumidor:APPINSIGHTS_INSTRUMENTATIONKEY" />
          </maps>
        </aCS>
        ...
        <aCS name="Produtor:APPINSIGHTS_INSTRUMENTATIONKEY" defaultValue="">
          <maps>
            <mapMoniker name="/AzureCloudService1/AzureCloudService1Group/MapProdutor:APPINSIGHTS_INSTRUMENTATIONKEY" />
          </maps>
        </aCS>
      ...
      <maps>
        <map name="MapConsumidor:APPINSIGHTS_INSTRUMENTATIONKEY" kind="Identity">
          <setting>
            <aCSMoniker name="/AzureCloudService1/AzureCloudService1Group/Consumidor/APPINSIGHTS_INSTRUMENTATIONKEY" />
          </setting>
        </map>
        ...
        <map name="MapProdutor:APPINSIGHTS_INSTRUMENTATIONKEY" kind="Identity">
          <setting>
            <aCSMoniker name="/AzureCloudService1/AzureCloudService1Group/Produtor/APPINSIGHTS_INSTRUMENTATIONKEY" />
          </setting>
        </map>
      ...
      <components>
        ...
        <groupHascomponents>
          <role name="Produtor" generation="1" functional="0" release="0" software="C:\Users\Diego\documents\visual studio 2017\Projects\AzureCloudService1\AzureCloudService1\csx\Release\roles\Produtor" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
              <aCS name="APPINSIGHTS_INSTRUMENTATIONKEY" defaultValue="" />
              <aCS name="Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" defaultValue="" />
